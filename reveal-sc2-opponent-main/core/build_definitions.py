...
BUILD_DEFINITIONS = {
    ...
    "PvT - 7 Gate Blink All-in": "Detected if Twilight Council is the FIRST tech building (before Robo AND Stargate), Blink is researched by 9:00, 6+ Gateways exist by 9:00, AND the 5th Gateway was STARTED before the 3rd Nexus -- a heavy Twilight-first multi-Gate Blink all-in. The Twilight-first guard keeps Robo-first openers with 6+ Gateways + late Blink off this label (those fall through to Robo First). \"Taken\" the 3rd Nexus means construction was initiated, not finished: a player can drop the 3rd Nexus and add Gateways while it is still building and those Gateways are still macro reinforcement. The build is excluded if the 3rd Nexus broke ground before the 5th Gateway.",
