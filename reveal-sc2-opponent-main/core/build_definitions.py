...
BUILD_DEFINITIONS = {
    ...
    "Protoss - DT Rush": "Detected if a Dark Shrine is built before 6:00 AND at least one real (non-hallucinated) Dark Templar is on the field by 7:00 -- a true DT harass opener. Mid-game DT-tech additions (Shrine going down after a Stargate or Robo opener) and Sentry-hallucinated Dark Templars are excluded.",
    ...
    "PvT - 2 Gate Blink (Fast 3rd Nexus)": "Detected if Blink is researched by 8:00, the player has taken 3+ Nexuses, exactly 2 Gateways were STARTED before the 3rd Nexus, AND a Robotics Facility is up by 8:00 -- a fast-3rd 2-Gate Blink style.",
    ...
    "Terran - Ghost Rush": "Detected if Ghost Academy is built within first 6:00 of the game -- a true 1-2 base Ghost commitment. Standard Bio macro builds usually add the Academy after 6:00 for mid-game snipes / EMPs and are excluded.",
    ...
    "Terran - BC Rush": "Detected if a Fusion Core is built before 6:30 AND at least one Battlecruiser is on the field by 8:30 -- a Starport-into-FC BC commitment. A Fusion Core alone is not enough; mech-into-late-game-BC macro games build FC for end-game composition and are excluded by the unit-presence requirement.",
