...
BUILD_DEFINITIONS = {
    ...
    "PvT - DT Drop": "Detected if a Dark Shrine is started by 3:45 AND a Robotics Facility is up by 4:00 AND at least one real (non-hallucinated) Dark Templar exists on the field by 4:30 AND a Warp Prism is on the field by 4:45 -- a fast tactical PvT DT drop. Cutoffs calibrated against a real PvT DT Drop replay (Peruano, Taito Citadel LE 2026-05-11: Shrine 3:13, Robo 3:32, DT 3:51, Prism 4:11) with ~30s buffer per signal.",
