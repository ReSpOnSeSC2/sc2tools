...
BUILD_DEFINITIONS = {
    ...
    "PvZ - Carrier Rush": "Detected if at least 1 Carrier has been produced by 10:00 -- skytoss into Carriers.",
    "PvZ - Tempest Rush": "Detected if at least 1 Tempest has been produced by 10:00 -- long-range Tempest harass / siege.",
    "PvZ - 2 Stargate Void Ray": "Detected if 2+ Stargates and 2+ Nexuses by 10:00, plus 4+ Void Rays produced by 10:00.",
    "PvZ - 3 Stargate Phoenix": "Detected if 3+ Stargates and 2+ Nexuses by 10:00, plus 4+ Phoenix produced by 10:00.",
    "PvZ - 2 Stargate Phoenix": "Detected if 2+ Stargates and 2+ Nexuses by 10:00, plus 4+ Phoenix produced by 10:00.",
    "PvZ - Rail's Disruptor Drop": "Detected if at least 1 Disruptor and at least 1 Warp Prism have both been produced by 8:00 -- an early Disruptor drop harass build.",
    "PvZ - AlphaStar Style (Oracle/Robo)": "Detected if 2+ Oracles and a Robotics Facility and a Forge are all in place by 8:30, with 3+ Nexuses by 8:30 -- the AlphaStar Oracle / Robo / fast 3rd composition.",
    "PvZ - 7 Gate Glaive/Immortal All-in": "Detected if Glaives is researched by 8:30, 2+ Sentries and 1+ Immortal are produced by 8:30, and 6+ Gateways exist by 9:00 -- a heavy Glaive Adept / Immortal all-in.",
    ...
    "PvZ - Archon Drop": "Detected if Stargate goes down before Twilight Council, a Templar Archives is up by 9:00, and 2+ Archons have been produced by 9:00 -- Stargate opener transitioning into Archon drops.",
    "PvZ - DT drop into Archon Drop": "Detected if Twilight Council goes down before Dark Shrine, a Dark Shrine is up by 9:00, 3+ Dark Templar are produced by 9:00, and a Warp Prism is on the field by 9:00.",
    ...
    "PvP - AlphaStar (4 Adept/Oracle)": "Detected if 4+ Adepts have been produced by 6:00 AND 1+ Oracle is on the field by 6:30 -- the AlphaStar 4-Adept / Oracle pressure opener.",
    "PvP - 4 Stalker Oracle into DT": "Detected if 3+ Stalkers by 6:30, 1+ Oracle by 7:30, and a Dark Shrine is built by 9:00 -- Stalker / Oracle harass transitioning into Dark Templar.",
    ...
    "PvP - Phoenix Style": "Detected if 3+ Phoenix have been produced by 8:30 -- an air-control / Phoenix-heavy PvP style.",
    ...
    "PvT - Phoenix into Robo": "Detected if 1+ Phoenix is on the field by 7:00 AND a Robotics Facility is up by 8:00 -- a Phoenix opener that transitions into Robo tech.",
    "PvT - Phoenix Opener": "Detected if 1+ Phoenix is on the field by 7:00 AND the player's second Gateway was built BEFORE the Robotics Facility -- a pure Phoenix opener.",
    ...
    "PvT - 2 Base Templar (Reactive/Delayed 3rd)": "Detected if a Templar Archives finishes BEFORE the third Nexus is taken AND the player has 4-6 Gateways by 7:30 -- a reactive 2-base High Templar / Storm timing with a delayed 3rd.",
    ...
    "PvT - DT Drop": "Detected if a Dark Shrine is built by 9:00 AND a Warp Prism is on the field by 10:00 -- a Dark Templar drop in PvT.",
