...
// Stage 11.3: tests inject SC2_META_DB_PATH / SC2_OPP_HISTORY_PATH
// to redirect file reads at a tmp fixture. Must be set BEFORE
// require('./analyzer'). Production leaves the env vars unset and
// resolves the canonical data/ files exactly as before.
...
function persistMetaDb() {
    ...
    atomicFs.atomicWriteJson(META_DB_PATH, dbCache.meta.data, { indent: 2 });
