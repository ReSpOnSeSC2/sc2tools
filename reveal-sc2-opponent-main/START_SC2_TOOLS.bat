...
echo [2/5] Starting Analyzer GUI (silent; logs to data\analyzer.log)...
...
echo [3/5] Starting Replay Watcher (live + deep)...
...
REM -- 5. Open the Web Analyzer in the default browser -------------
...
echo [5/5] Waiting for backend health then opening Web Analyzer...
